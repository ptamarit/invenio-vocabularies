...
class CORDISProjectHTTPReader(BaseReader):
    ...
    def read(self, item=None, *args, **kwargs):
        ...
        file_url = "https://cordis.europa.eu/data/cordis-HORIZONprojects-json.zip"
...
class CORDISProjectTransformer(BaseTransformer):
    ...
    def apply(self, stream_entry, **kwargs):
        ...
        award["id"] = f"00k4n6c32::{record['projectID']}"

        if "euroSciVocTitle" in record:
            # TODO: This is overwritting the subject instead of adding them since there is 1 apply per subject.
            #       Use the individual project XML files instead to avoid this problem.
            award["subjects"] = [
                {
                    "scheme": "EuroSciVoc",
                    # TODO: Here lowercase while title cased in the subjects vocabulary.
                    "subject": record["euroSciVocTitle"],
                }
            ]

            # TODO: This contains another type of identifier not stored in the DB.
            #award["euroscivoc_code"] = record["euroSciVocCode"]
        else:
            award["organisation_id"] = record["organisationID"]
            award["country"] = record["country"]
...
DATASTREAM_CONFIG = {
    "readers": [
        ...
        #     "type": "zip",
        #     "args": {
        #         "regex": "^json/(?:organization|euroSciVoc)\\.json$",
        #         "mode": "r",
        #     },
        # },
        {"type": "json"},
